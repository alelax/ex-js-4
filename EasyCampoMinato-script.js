...
function startGame() {
   do {
      var gameLevel = parseInt( prompt("DIGITA 1, 2 o 3 PER SCEGLIERE IL LIVELLO DI DIFFICOLTA:\n\n- facile [1]\n- medio [2]\n- difficile [3]\n- test [4]") );
   ...
   switch (setting.gameLevel) {
      case 1:
         setting.maxNum = 100;
         setting.maxScore = setting.maxNum - setting.howMany;
         break;
      case 2:
         setting.maxNum = 80;
         setting.maxScore = setting.maxNum - setting.howMany;
